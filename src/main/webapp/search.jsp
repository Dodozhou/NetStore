...
<div style="max-width: 1400px;margin: 0 auto;">
            ...
            <div class="register_box" id="register_box">
                ...
                <div class="register-main" >
					...
					<font color='black'>看不清，换一张</font>
                        ...
                        <input type="reset"  class="register" value=" 重   置 "><br/><br/>
    ...
    <div class="main row">
        ...
        <div class="wantbuy col-6 " >
            <a href="${pageContext.request.contextPath}/product?method=findById&id=${p.id}">
            <h2 style="color: #02212C">${p.name}</h2>
                   <img  src="${pageContext.request.contextPath}${p.imgurl_s}" ><br/>
                    <p style="color: #02212C">描述:${p.description}</p>
                  <p style="color: #02212C">  ￥ <strong style="color:red;"> ${p.price}</strong> 元</p>
            </a>
        </div>
        </c:forEach>
