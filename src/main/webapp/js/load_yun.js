...
$(document).ready(function () {
    ...
    //校园代步 transport
    $.getJSON("http://www.deardull.com/BookStore/product?method=findByCategory&category=transport",function (ps1) {
        $.each(ps1,function(index){
            $("#transport").after(
                "<div class='col-12'> <div class='shangpin1' >"+
                "<a href='http://www.deardull.com/BookStore/product?method=findById&id="+ps1[index].id+"' style='display: block;'>"+
                "<div class='img'>"+
                "<img  src='http://www.deardull.com/BookStore/"+ps1[index].imgurl+"'/>"+
                "</div> <div class='description'>"+
    ...
    //电脑 computer
    $.getJSON("http://www.deardull.com/BookStore/product?method=findByCategory&category=computer",function (ps1) {
        $.each(ps1,function(index){
            $("#computer").after(
                "<div class='col-12'> <div class='shangpin1' >"+
                "<a href='http://www.deardull.com/BookStore/product?method=findById&id="+ps1[index].id+"' style='display: block;'>"+
    ...
    //数码产品 electronics
    $.getJSON("http://www.deardull.com/BookStore/product?method=findByCategory&category=electronics",function (ps1) {
        $.each(ps1,function(index){
            $("#electronics").after(
                "<div class='col-12'> <div class='shangpin1' >"+
                "<a href='http://www.deardull.com/BookStore/product?method=findById&id="+ps1[index].id+"' style='display: block;'>"+
    ...
    //运动健身 exercise
    $.getJSON("http://www.deardull.com/BookStore/product?method=findByCategory&category=exercise",function (ps1) {
        $.each(ps1,function(index){
            $("#exercise").after(
                "<div class='col-12'> <div class='shangpin1' >"+
                "<a href='http://www.deardull.com/BookStore/product?method=findById&id="+ps1[index].id+"' style='display: block;'>"+
    ...
    //日常用品 daily
    $.getJSON("http://www.deardull.com/BookStore/product?method=findByCategory&category=daily",function (ps1) {
        $.each(ps1,function(index){
            $("#daily").after(
                "<div class='col-12'> <div class='shangpin1' >"+
                "<a href='http://www.deardull.com/BookStore/product?method=findById&id="+ps1[index].id+"' style='display: block;'>"+
    ...
    //图书素材 books
    $.getJSON("http://www.deardull.com/BookStore/product?method=findByCategory&category=books",function (ps1) {
        $.each(ps1,function(index){
            $("#books").after(
                "<div class='col-12'> <div class='shangpin1' >"+
                "<a href='http://www.deardull.com/BookStore/product?method=findById&id="+ps1[index].id+"' style='display: block;'>"+
    ...
    //其他 other
    $.getJSON("http://www.deardull.com/BookStore/product?method=findByCategory&category=other",function (ps1) {
        $.each(ps1,function(index){
            $("#other").after(
                "<div class='col-12'> <div class='shangpin1' >"+
                "<a href='http://www.deardull.com/BookStore/product?method=findById&id="+ps1[index].id+"' style='display: block;'>"+
