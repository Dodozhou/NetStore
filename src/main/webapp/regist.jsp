...
<form action="${pageContext.request.contextPath }/user" method="post"
    ...
    <table border="1" align="center" width="65%">
        ...
        <tr>
            <td colspan="2" align="center"><input type="submit" id="regist" value="注册">&nbsp;&nbsp;&nbsp;&nbsp;<input
                    type="reset" value="取消"></td>
        </tr>

    </table>
</form>
<div style="text-align: center;font-size: larger;color: red">
    <span id="notice"></span>
...
<script type="application/javascript">
    $(document).ready(function(){
        $("#regist").click(function(){
            if (document.getElementById("checkcode")==<%=check_code%>) {
                $.post("${pageContext.request.contextPath }/user?method=regist",
                        {
                            username:document.getElementById("username") ,
                            password:document.getElementById("username") ,
                            repassword:document.getElementById("username") ,
                            nickname:document.getElementById("username") ,
                            email:document.getElementById("username") ,
                            checkcode:document.getElementById("username")
                        });
            }else{
                document.getElementById("notice").innerHTML="验证码错误，请重新输入！";
            }
        });
    });
